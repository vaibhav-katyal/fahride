    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 pb-20">
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8 space-y-6">
          {/* Last Updated */}
          <div className="text-sm text-slate-500 border-l-4 border-green-500 pl-4">
            Last updated: April 5, 2026
          </div>

          {/* Introduction */}
          <section className="space-y-3">
            <h2 className="text-2xl font-bold text-slate-900">Privacy at FAH Ride</h2>
          ...
          <section className="space-y-3">
            ...
            <p className="text-slate-700 leading-relaxed font-medium mb-3">Account and Identity Information:</p>
            ...
            <p className="text-slate-700 leading-relaxed font-medium mt-4 mb-3">Ride and Transportation Information:</p>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-2">
            ...
            <p className="text-slate-700 leading-relaxed font-medium mt-4 mb-3">Communication Data:</p>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-2">
            ...
            <p className="text-slate-700 leading-relaxed font-medium mt-4 mb-3">Technical Information:</p>
            <ul className="list-disc list-inside space-y-2 text-slate-700 ml-2">
          ...
          {/* Section 3 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">3. Information Sharing and Disclosure</h3>
            <p className="text-slate-700 leading-relaxed font-medium mb-3">Who We Share Your Information With:</p>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 5 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">5. Data Retention</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 6 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">6. Location Data and GPS Tracking</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 7 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">7. Cookies and Local Storage</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 8 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">8. Your Privacy Rights</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 9 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">9. Students Only and Age Requirements</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 10 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">10. Third-Party Links</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 11 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">11. Policy Updates</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          {/* Section 12 */}
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-slate-900">12. Contact Us for Privacy Concerns</h3>
            <p className="text-slate-700 leading-relaxed">
